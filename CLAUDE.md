...
3. Generates `000_buffer_upload.csv` in the input directory (numeric prefix sorts to top)
4. CSV columns: `Text`, `Image URL`, `Tags`, `Posting Time` (only Text is filled)
5. Posts are ordered alphabetically (case-insensitive), matching folder listing order
